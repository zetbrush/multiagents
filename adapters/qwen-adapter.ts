#!/usr/bin/env bun
/**
 * QwenAdapter — MCP adapter for Qwen CLI instances.
 *
...
export class QwenAdapter extends BaseAdapter {
  ...
  getSystemPrompt(): string {
    ...
    const base = `You are an Alibaba Qwen CLI instance (Qwen3 / Qwen2.5-coder) on the multiagents network.
...
QUALITY: Production-grade code. Plan before coding. Verify before signaling done.`;
   ...
   * the file-based inbox so Qwen sees it via native file reads.
   */
